...
### Timeline of Entry Restrictions
...
::: {.fragment}
  ...
  - Admission or procedure codes before/after construction
:::
...
![](images/total-admits.png){width=60% fig-align="center"}

---

### Potential Solution

![](images/shapiro-wiggly.png){fig-align="center"}
...
- Great data, well suited to study effects of hospital "growth"
- Decomposing additional admissions into expansion versus unmet need is important here
- Opportunity to identify pre-construction capacity constrained vs. unconstrained hospitals
