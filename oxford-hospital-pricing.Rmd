...
Some thoughts on U.S. health care...

1. [Quality is OK](#health)

2. [The System is Confusing](#complex)

3. [Prices are Really High!](#high)

4. [Economics can help][#economics]
...
.center[
![:scale 70%](images/price-comparison.png)
]
...
.center[
![:scale 70%](images/price-compare2.png)
]
...
.center[
![:scale 70%](images/price-compare3.png)
]
...
.center[
  ![:scale 70%](images/DifferentPrices.jpg)
]
...
.pull-left[
  ![:scale 100%](images/GHT1.png)
]

.pull-right[
  ![:scale 100%](images/GHT2.png)
]
